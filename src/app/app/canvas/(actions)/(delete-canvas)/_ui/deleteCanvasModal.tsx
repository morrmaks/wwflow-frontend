...
import { useDeleteCanvasModal } from '../_hooks/useDeleteCanvasModal';

interface DeleteCanvasModalProps {
  canvas: CanvasListFieldsFragment;
}

function DeleteCanvasModal({ canvas }: DeleteCanvasModalProps) {
  const { handleDelete } = useDeleteCanvasModal(canvas);
