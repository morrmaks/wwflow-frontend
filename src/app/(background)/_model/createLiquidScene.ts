import { isMobileDevice } from '@src/common/lib/device';
...
function createLiquidScene(container: HTMLDivElement, theme?: string) {
...
type LiquidScene = ReturnType<typeof createLiquidScene>;

export { createLiquidScene, type LiquidScene };
